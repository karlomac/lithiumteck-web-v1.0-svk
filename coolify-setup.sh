...
echo "   □ Create new resource → Dockerfile"
...
echo "========================"
echo ""
echo "• Dockerfile deployment: COOLIFY-DOCKERFILE.md"
echo "• Quick reference: COOLIFY-QUICKSTART.md"
...
echo "   coolify deploy --dockerfile Dockerfile"
echo ""
